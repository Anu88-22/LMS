            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="text-center text-sm text-gray-600 mt-4">
                        ...
                        <Link href={`/auth/register?redirect=${encodeURIComponent(redirectTo)}`} className="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition">
                            Sign up here
                        </Link>
                    </div>
                </form>
